    ...
    fluidRow(
      column(7,
        ...
        tags$div(
          ...
          tags$div(style = "margin-bottom: 8px;", HTML("✓ Custom donor dashboards with ML predictions")),
          tags$div(style = "margin-bottom: 8px;", HTML("✓ Automated grant reporting systems")),
          tags$div(style = "margin-bottom: 8px;", HTML("✓ Real-time fundraising campaign tracking")),
          tags$div(style = "margin-bottom: 8px;", HTML("✓ Board meeting analysis and insights")),
          tags$div(style = "margin-bottom: 8px;", HTML("✓ Integration with your existing CRM/database"))
        )
      ),
      column(5,
        div(
